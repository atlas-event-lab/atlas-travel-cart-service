...
class CartServiceImplTest {
  ...
  class GetCart {
    ...
    void throwsNotFoundForUnknownCart() {
      ...
      assertThatThrownBy(() -> service.getCart(unknownId, USER_ID))
    ...
    void throwsGoneForExpiredCart() {
      ...
      assertThatThrownBy(() -> service.getCart(cart.getId(), USER_ID))
  ...
  class UpsertItem {
    ...
    void addsFlight() {
      ...
      CartResponse response = service.upsertItem(cart.getId(), USER_ID, CartItemType.FLIGHT,
          request);
    ...
    void throwsNotActiveForConvertedCart() {
      ...
      assertThatThrownBy(
          () -> service.upsertItem(cart.getId(), USER_ID, CartItemType.FLIGHT, flightRequest()))
