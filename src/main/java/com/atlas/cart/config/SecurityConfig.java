...
/**
 * Configures the service as an OAuth2 JWT resource server (SEC-001, SEC-002). All cart endpoints
 * require a valid Keycloak-issued JWT; only the Actuator health/info probes are public. The service
 * never issues tokens (SEC-003).
 */
@Configuration
@EnableWebSecurity
