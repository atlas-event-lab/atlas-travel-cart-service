...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleForbidden(CartNotOwnedException ex, HttpServletRequest request) {
        return respond(HttpStatus.FORBIDDEN, problem(HttpStatus.FORBIDDEN, ex.getMessage(),
    ...
    public ResponseEntity<ProblemDetail> handleGone(CartExpiredException ex, HttpServletRequest request) {
        return respond(HttpStatus.GONE, problem(HttpStatus.GONE, ex.getMessage(),
    ...
    public ResponseEntity<ProblemDetail> handleConflict(CartNotActiveException ex, HttpServletRequest request) {
        return respond(HttpStatus.CONFLICT, problem(HttpStatus.CONFLICT, ex.getMessage(),
    ...
    public ResponseEntity<ProblemDetail> handleUnprocessable(CurrencyMismatchException ex, HttpServletRequest request) {
        return respond(HttpStatus.UNPROCESSABLE_ENTITY, problem(HttpStatus.UNPROCESSABLE_ENTITY, ex.getMessage(),
    ...
    public ResponseEntity<ProblemDetail> handleNoResource(NoResourceFoundException ex, HttpServletRequest request) {
        return respond(HttpStatus.NOT_FOUND, problem(HttpStatus.NOT_FOUND, "Resource not found",
                ProblemTypes.NOT_FOUND, "Not Found", request));
    }
    ...
    public ResponseEntity<ProblemDetail> handleGeneric(Exception ex, HttpServletRequest request) {
        ...
        return respond(HttpStatus.INTERNAL_SERVER_ERROR, problem(HttpStatus.INTERNAL_SERVER_ERROR,
                "An unexpected error occurred", ProblemTypes.INTERNAL_ERROR, "Internal Server Error", request));
    }

    private ProblemDetail problem(HttpStatus status, String detail, URI type, String title, HttpServletRequest request) {
